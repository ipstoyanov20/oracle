...
{
    private readonly IInfoService<PersonalInfoIM, PersonalInfoVM> personalInfoService;
    private readonly IInfoService<CarInfoIM, CarInfoVM> carInfoService;
    ...
    /// <param name="carInfoService">carInfo service.</param>
    ...
    public ResumesController(
        IInfoService<PersonalInfoIM, PersonalInfoVM> personalInfoService,
        IInfoService<CarInfoIM, CarInfoVM> carInfoService,
    ...
    public async Task<ActionResult<ResumeVM>> CreateResumeAsync([FromBody] ResumeIM resumeIM)
    {
        ...
        var personalInfo = await this.personalInfoService
                                        .CreateForUserWithIdAsync(this.currentUser.UserId);

        var carInfo = await this.carInfoService
                                        .CreateForUserWithIdAsync(this.currentUser.UserId);

        var resume = await this.resumeService.CreateResumeAsync(resumeIM, personalInfo.Id, carInfo.Id, this.currentUser.UserId);
