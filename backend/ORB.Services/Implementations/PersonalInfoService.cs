...
/// </summary>
internal class PersonalInfoService : IInfoService<PersonalInfoIM, PersonalInfoVM>
{
    ...
    /// <inheritdoc/>
    public async Task<PersonalInfoVM> CreateForUserWithIdAsync(string id)
    {
    ...
    /// <inheritdoc/>
    public async Task<PersonalInfoVM?> GetByIdAsync(string id, string userId)
    {
    ...
    /// <inheritdoc/>
    public async Task<PersonalInfoVM> UpdateWithIdAsync(string id, PersonalInfoIM newPersonalInfo)
    {
